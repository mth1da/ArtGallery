...
<form class="needs-validation" novalidate action="modifyOeuvre" method="post">
    <%
        ...
        ArtisteDAO ae = new ArtisteBDD();
        OeuvreDAO oe=new OeuvreBDD();
        List< Oeuvre> lesOeuvres = (List<Oeuvre>) oe.getAllUserOeuvres(us);
        List<Artiste> lesArtistes = (List<Artiste>) ae.getAllUserArtiste(us);
        for(Oeuvre o : lesOeuvres) {
    %>
    <div class="form-row">
        <div class="col-md-4 mb-3">
            <label for="validationCustom01"> Titre de l'oeuvre </label>
            <input type="text" class="form-control" name="title" id="validationCustom01" placeholder="First name" value="<%=o.getName()%>" required>
        ...
        <div class="col-md-4 mb-3">
            ...
            <input type="text" class="form-control" name="name" id="validationCustom02" placeholder="Last name" value="<%=o.getPrice()%>" required>
            <div class="valid-feedback">
                Looks good!
            </div>
        </div>
        <%
            ...
            for(Artiste a : lesArtistes) {
        %>
        <div class="col-md-4 mb-3">
            <label for="validationCustomUsername">Prénom de l'artiste</label>
            <div class="input-group">
                <div class="input-group-prepend">
                    <span class="input-group-text" id="inputGroupPrepend"></span>
                </div>
                <input type="text" name="lastName" class="form-control" id="validationCustomUsername" placeholder="Username" aria-describedby="inputGroupPrepend" value="<%=a.getLastName()%>" required>
    ...
    <div class="form-row">
        <div class="col-md-6 mb-3">
            <label for="validationCustom03">Nom de l'artiste</label>
            <input type="text" name="price" class="form-control" id="validationCustom03" placeholder="Prix" value="<%=a.getName()%>" required>
            <div class="invalid-feedback">
